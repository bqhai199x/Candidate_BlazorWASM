        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    InterContacted = table.Column<int>(type: "int", nullable: false),
                    InterTime = table.Column<DateTime>(type: "datetime2", nullable: true),
                    InterLocation = table.Column<string>(type: "nvarchar(max)", nullable: true),
                    InterNote = table.Column<string>(type: "nvarchar(max)", nullable: true),
