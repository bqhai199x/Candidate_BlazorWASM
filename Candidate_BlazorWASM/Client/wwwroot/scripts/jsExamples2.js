...
jsFunctions.calculateSquareRoot = function () {
    ...
    DotNet.invokeMethodAsync("Candidate_BlazorWASM.Client", "CalculateSquareRoot", parseInt(number))
        .then(result => {
...
jsFunctions.calculateSquareRootWithJustResult = function () {
    ...
    DotNet.invokeMethodAsync("Candidate_BlazorWASM.Client", "CalculateSquareRootWithJustResult", parseInt(number), true)
        .then(result => {
